...
# Don't run this prgram yet!! This following bit is new, but the ##### lines are showing the previous, older stuff
with h5py.File(''{}/*'.format(args.images_dir)', 'a') as hf:
    hf["X_train"].resize((hf["X_train"].shape[0] + X_train_data.shape[0]),
                            axis = 0, resample=pil_image.BICUBIC)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--scale', type=int, default=4) # originally 2
